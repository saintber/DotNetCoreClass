...
namespace HomeWork.Migrations
{
    ...
    [Migration("20201211154433_UpdateAndDeleteField")]
    partial class UpdateAndDeleteField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeWork.Entity.Course", b =>
                {
            ...
            modelBuilder.Entity("HomeWork.Entity.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("HomeWork.Entity.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HomeWork.Entity.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("HomeWork.Entity.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("HomeWork.Entity.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HomeWork.Entity.VwCourseStudent", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("HomeWork.Entity.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("HomeWork.Entity.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("HomeWork.ViewModels.CreateDepartmentResult", b =>
                {
                    b.Property<int>("DepartmentId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CreateDepartmentResult");
                });

            modelBuilder.Entity("HomeWork.Entity.Course", b =>
                {
                    b.HasOne("HomeWork.Entity.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("HomeWork.Entity.CourseInstructor", b =>
                {
                    b.HasOne("HomeWork.Entity.Course", "Course")
                    ...
                    b.HasOne("HomeWork.Entity.Person", "Instructor")
                        .WithMany("CourseInstructors")
            ...
            modelBuilder.Entity("HomeWork.Entity.Enrollment", b =>
                {
                    ...
                    b.HasOne("HomeWork.Entity.Person", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("HomeWork.Entity.OfficeAssignment", b =>
                {
                    b.HasOne("HomeWork.Entity.Person", "Instructor")
                        ...
                        .HasForeignKey("HomeWork.Entity.OfficeAssignment", "InstructorId")
